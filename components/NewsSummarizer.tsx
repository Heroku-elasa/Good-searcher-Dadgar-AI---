...
const NewsSummarizer: React.FC<NewsSummarizerProps> = ({
    ...
    const handleQueryChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
        ...
        suggestionTimeoutRef.current = window.setTimeout(async () => {
            const context = t('newsSummarizer.queryLabel');
    ...
    const examples: { label: string; query: string; }[] = t('newsSummarizer.examples');
                ...
                <div className="mt-10 bg-gray-800/50 rounded-lg p-8 shadow-lg backdrop-blur-sm border border-gray-700">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {Array.isArray(examples) && examples.length > 0 && (
                          <div className="pt-2">
                            <p className="text-sm font-medium text-gray-400 mb-3">{t('newsSummarizer.tryExample')}</p>
